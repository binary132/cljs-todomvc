...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14562 = (0);while(true){
var m_14563 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14563 == null))
{} else
{m_14563.call(null);
if((count_14562 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14564 = (count_14562 + (1));
count_14562 = G__14564;
continue;
}
} else
{}
