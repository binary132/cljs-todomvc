...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14482 = (0);while(true){
if((i_14482 < arr.length))
{(arr[i_14482] = null);
{
...
{var i_14489 = (self__.level + (1));while(true){
if((i_14489 <= (new_level + (1))))
{(update[i_14489] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14491 = (0);while(true){
if((i_14491 <= self__.level))
{var links_14492 = (update[i_14491]).forward;if(((links_14492[i_14491]) === x__$1))
{(links_14492[i_14491] = (x__$1.forward[i_14491]));
{
var G__14493 = (i_14491 + (1));
i_14491 = G__14493;
continue;
}
} else
{{
var G__14494 = (i_14491 + (1));
i_14491 = G__14494;
continue;
}
}
