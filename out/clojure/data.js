...
{return cljs.core.reduce.call(null,(function (result,p__14843){var vec__14844 = p__14843;var k = cljs.core.nth.call(null,vec__14844,(0),null);var v = cljs.core.nth.call(null,vec__14844,(1),null);return cljs.core.assoc.call(null,result,k,v);
...
*/
clojure.data.diff_associative_key = (function diff_associative_key(a,b,k){var va = cljs.core.get.call(null,a,k);var vb = cljs.core.get.call(null,b,k);var vec__14846 = clojure.data.diff.call(null,va,vb);var a_STAR_ = cljs.core.nth.call(null,vec__14846,(0),null);var b_STAR_ = cljs.core.nth.call(null,vec__14846,(1),null);var ab = cljs.core.nth.call(null,vec__14846,(2),null);var in_a = cljs.core.contains_QMARK_.call(null,a,k);var in_b = cljs.core.contains_QMARK_.call(null,b,k);var same = (in_a) && (in_b) && ((!((ab == null))) || (((va == null)) && ((vb == null))));return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((in_a) && ((!((a_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,a_STAR_], true, false):null),(((in_b) && ((!((b_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,b_STAR_], true, false):null),((same)?new cljs.core.PersistentArrayMap.fromArray([k,ab], true, false):null)], null);
});
/**
...
clojure.data.EqualityPartition = (function (){var obj14848 = {};return obj14848;
})();
...
{var x__4277__auto__ = (((x == null))?null:x);return (function (){var or__3640__auto__ = (clojure.data.equality_partition[goog.typeOf(x__4277__auto__)]);if(or__3640__auto__)
...
clojure.data.Diff = (function (){var obj14850 = {};return obj14850;
})();
...
{var x__4277__auto__ = (((a == null))?null:a);return (function (){var or__3640__auto__ = (clojure.data.diff_similar[goog.typeOf(x__4277__auto__)]);if(or__3640__auto__)
{return or__3640__auto__;
} else
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__14851 = x;if(G__14851)
{var bit__4304__auto__ = (G__14851.cljs$lang$protocol_mask$partition0$ & (1024));if((bit__4304__auto__) || (G__14851.cljs$core$IMap$))
{return true;
} else
{if((!G__14851.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__14851);
} else
{return false;
}
}
...
{var bit__4304__auto__ = (G__14852.cljs$lang$protocol_mask$partition0$ & (4096));if((bit__4304__auto__) || (G__14852.cljs$core$ISet$))
{return true;
} else
{if((!G__14852.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__14852);
} else
{return false;
}
}
...
{if((function (){var G__14853 = x;if(G__14853)
{var bit__4304__auto__ = (G__14853.cljs$lang$protocol_mask$partition0$ & (16777216));if((bit__4304__auto__) || (G__14853.cljs$core$ISequential$))
{return true;
} else
{if((!G__14853.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__14853);
} else
{return false;
}
}
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__14854 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);switch (G__14854) {
case "map":
